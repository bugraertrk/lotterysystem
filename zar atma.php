    ...
    <div class="container">
      ...
      <div class="navbar-left">
        <button class="navbar-toggler" type="button">&#9776;</button>
          <a href="/BrosCekilis/index.html"><img class="logo-dark" src="https://i.imgyukle.com/2021/06/15/O0fh6h.png" alt="Online Çekiliş Yap" style="height:40px;"></a>
          <a href="/BrosCekilis/index.html"><img class="logo-light" src="https://i.imgyukle.com/2021/06/15/O0fh6h.png" alt="Online Çekiliş Yap" style="height:40px;"></a>
      </div>
  ...
  <div class="container text-center">
    ...
    <div class="row">
      <div class="col-md-8 mx-auto">
        ...
        <h1>Online Zar At</h1>
        <p class="lead-2">Ücretsiz Zar at, kazananı belirle!<br> Zarları hızlı bir şekilde yapmak için, ücretsiz zar atma aracımızı kullanabilirsiniz.</p>
    ...
    <div class="container">
      <div class="row">
        <form id="update"  method="post" class="col-md-8 mx-auto p-6 bg-secondary rounded">
          <center><h3 class="section-heading">Zar Oyununa Hoşgeldiniz</h3> <br> 
          <font color="black" face="tahoma">1. İsim :</font>	<input type="text" name="isim1" required><br><br>
          <font color="black" face="tahoma">2. İsim :</font>	<input type="text" name="isim2" required><br><br><br>
            ...
            <?php 
              ...
              if (isset($_POST['gonder'])) {
                ...
                header("Location: \BrosCekilis\zar\zar-oyunu.php");
                            }
            ?>
            <hr/>
        <p>
    ...
    <div class="row gap-y">
      <div class="col-md-6">
        <div class="row">
          ...
          <div class="col-6">
            <p class="small text-uppercase ls-2 mb-2">Yapılan zar atma</p>
