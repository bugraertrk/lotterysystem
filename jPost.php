...
$sonuc .= "Çekiliş Tarihi : ".$tarih."</br><hr>";
...
if($kazanacak_sayisi <= $cntr){
	if(!empty($isEmpty)){
		...
		fwrite($handle, $sonuc);
		fclose($handle);
		echo "</br><a href='download.php?tarih=".$tarih2."'><button style=background-color:tomato;color:white;width:100%; border-radius: 20px;>Text Olarak İndir</button></a>";
	}else{
		echo "Boş bırakmayın.";
	}
}else{
